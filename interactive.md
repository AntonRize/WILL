...
<script>
const betaCanvas = document.getElementById('emc2-canvas');
const betaTri = new Chart(betaCanvas,{type:'line',data:{datasets:[{label:'β-γ',data:[{x:0,y:1},{x:0.65,y:1.316}]}]},options:{responsive:true,scales:{x:{min:0,max:1},y:{min:0,max:3}}});
